                                            ...
                                            <form action="" method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control form-control-lg" type="date" name="kunjungan_pasien_tgl_lahir" value="<?= $data['kunjungan_pasien_tgl_lahir'] ?>" placeholder="Umur..." value="18" required />
                                                    </div>
                                                    <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <form action="" method="post">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Tanggal lahir</label>
                        <input class="form-control form-control-lg" type="date" name="kunjungan_pasien_tgl_lahir" placeholder="Tanggal lahir..." required />
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Poli</label>
                        <select name="kunjungan_poli_id" class="form-control form-control-lg" required>
