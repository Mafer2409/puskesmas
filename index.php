...
<head>
    <meta charset="utf-8">
    <title>Puskesmas Lewolaga</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="admin/img/logo/puskesmas-logo.png" rel="icon">
        ...
        <div class="container py-3">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-auto d-flex align-items-center">
                    ...
                    <small class="ms-4"><i class="fa fa-phone-alt me-3"></i>+62 812 3710 7839</small>
                    <div class="ms-3 d-flex">
                        <a href="index2.php" class="btn btn-light rounded-pill py-2 px-3 mt-2 mb-2">Sign In!</a>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                <a href="index.html" class="navbar-brand d-lg-none">
                    <h1 class="fw-bold m-0">Puskesmas Lewolaga</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="ms-auto d-none d-lg-block">
                        <!-- <a href="" class="btn btn-primary rounded-pill py-2 px-3 mt-2 mb-2">Get A Quote</a> -->
                    </div>
                </div>
            </nav>
        </div>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="assets/img/gbr-puskesmas.JPG" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7 text-start">
                                    <p class="fs-4 text-white animated slideInRight" style="text-shadow: 2px 2px #696969;" style="text-shadow: 2px 2px #696969;">Selamat datang di...</p>
                                    <h1 class="display-1 text-white mb-4 animated slideInRight" style="text-shadow: 4px 4px #696969;">Puskesmas Lewolaga</h1>
                                    <a href="index2.php" class="btn btn-primary rounded-pill py-3 px-5 animated slideInRight">Sign In!</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-7 text-end">
                                    <p class="fs-4 text-white animated slideInLeft" style="text-shadow: 2px 2px #696969;">Selamat datang di...</p>
                                    <h1 class="display-1 text-white mb-5 animated slideInLeft" style="text-shadow: 4px 4px #696969;">Puskesmas Lewolaga</h1>
                                    <a href="index2.php" class="btn btn-primary rounded-pill py-3 px-5 animated slideInLeft">Sign In!</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="feature-item border h-100 p-5">
                        <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                            <img class="img-fluid" src="assets-template/img/icon/icon-2.png" alt="Icon">
                        </div>
                        <h5 class="mb-3">Poli Umum</h5>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h3>"Terwujudnya Masyarakat Titehena Yang Sehat, Mandiri, Keadilan dan Missioner."</h3>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="text-dark">1. Pemberdayaan masyarakat melalui program-program pelayanan kesehatan.</p>
                    <p class="mb-4 text-dark">2. Peningkatan pelayanan kesehatan yang prima, professional (sikap dan keterampilan).</p>
                    <p class="mb-4 text-dark">3. Menjalin kerjasama lintas sektor secara bertangung jawab.</p>
                    <p class="mb-4 text-dark">4. Membangun kemitraan dengan multi pihak (tokoh agama, tokoh adat, tokoh masyarakat dan lembaga swadaya masyarakat.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <h4 class="text-white mb-4">Puskesmas Lewolaga</h4>
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Jl. Negara Trans, Lewolaga, Flores Timur</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+62 812 3710 7839</p>
